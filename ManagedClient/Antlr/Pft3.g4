...
selectStatement :   SELECT selectValue=simpleFormat
                    (   CASE
                        ...
                        COLON
                        optionFormat=compositeElement+
                    )+
                    (   ELSE
                        elseFormat=compositeElement+
                    )?
                    END
                ;
...
combineFunction :   COMBINE
                    LPAREN
                    arg1=compositeElement
                    COMMA
                    arg2=compositeElement
                    RPAREN
                ;
...
conditionalStatement
                :   IF condition
                    THEN thenBranch=compositeElement*
                    ( ELSE elseBranch=compositeElement* )?
                    FI
                ;
